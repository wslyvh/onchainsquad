  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-4 md:p-16">
      <div className="flex flex-col place-items-center">
        ...
        <form action="https://login.sendpulse.com/forms/simple/u/eyJ1c2VyX2lkIjo4Mzk2NTA3LCJhZGRyZXNzX2Jvb2tfaWQiOjQ4MzgwNywibGFuZyI6ImVuIn0=" target="_blank" method="post">
          <div className='flex flex-col text-neutral-content items-center text-center gap-8'>
            ...
            <div className='flex flex-col gap-4'>
              ...
              <input type="hidden" name="sender" value="hello@onchainsquad.com" />
